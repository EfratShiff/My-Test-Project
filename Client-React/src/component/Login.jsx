...
//         try {
//             const emailToSend = data.forgotEmail || data.email;

//             const res = await axios.post('http://localhost:8080/User/forgot-password', {
//                 email: emailToSend
//             });

//             alert("סיסמה זמנית נשלחה למייל שלך. בדוק את הדוא\"ל והתחבר עם הסיסמה הזמנית.");
...
//                                         <form onSubmit={handleSubmit(sendTempPasswordToEmail)}>
//                                             <DialogContent>
//                                                 <DialogContentText>
...
//                                                     helperText={errors.forgotEmail ? "יש להזין אימייל" : ""}
//                                                     {...register("forgotEmail", { required: true })}
//                                                 />
//                                             </DialogContent>
//                                             <DialogActions>
...
//     // הפונקציה המתוקנת לשליחת סיסמה זמנית
//     const sendTempPasswordToEmail = async (data) => {
...
//             setTempPasswordEmail(emailToSend); // שמירת המייל לשלב הבא
//             setShowForgotPassword(false);
//             setShowTempPasswordInput(true); // מעבר לשלב אימות הסיסמה הזמנית
//         } catch (err) {
...
//     // פונקציה חדשה לאימות סיסמה זמנית
...
const Login = () => {
    ...
    return (
        <Container component="main" maxWidth="sm" dir="rtl">
            ...
            {/* דיאלוג שכחתי סיסמה - הועבר החוצה מהקומפוננט הראשי */}
            <Dialog open={showForgotPassword} onClose={() => setShowForgotPassword(false)}>
                <DialogTitle>איפוס סיסמה</DialogTitle>
                <form onSubmit={handleForgotPasswordSubmit((data) => {
                    console.log("Forgot password form submitted with data:", data);
            ...
            {/* דיאלוג אימות סיסמה זמנית - הועבר החוצה מהקומפוננט הראשי */}
            <Dialog open={showTempPasswordInput} onClose={() => {
                setShowTempPasswordInput(false);
                setTempPasswordEmail("");
            }}>
